...
export default class AccountsProxy extends Component {
  ...
  handleOnChange = (value) => {
    ...
    const sp = (totalVestsDPay * vests / totalVests).toFixed(3);
  ...
  handleOnChangeInput = (e, props) => {
    ...
    const globalProps = this.props.dpay.props;
    const totalVestsDPay = parseFloat(globalProps.total_vesting_fund_dpay.split(" ")[0])
    ...
    if (name === 'vests') {
      ...
      sp = (totalVestsDPay * fixed / totalVests).toFixed(3)
      vests = value
    }
    if (name === 'sp') {
      const fixed = parsed.toFixed(3);
      sp = value
      vests = (fixed / totalVestsDPay * totalVests).toFixed(6)
    }
    this.setState({ vests, sp });
  }
            ...
            >
              ...
              >
                  ...
                  <Grid.Row>
                    ...
                    <Grid.Column width={4}>
                      <Header textAlign="center" size="large">
                        <Header.Subheader>DPay Power</Header.Subheader>
                ...
                <Message
                  ...
                  header="Warning! Delegating too much BP."
                  content="Leaving so little BP in this account may cause it to stop functioning, meaning you may have to power up more DPay or Delegate to this account from another in order to even undo what you are about to do."
                />
                <Message
